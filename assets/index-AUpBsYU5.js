...
const computer = "/Portfolio/assets/computer-o7yxjvuq.png";
const profileImg = "/Portfolio/assets/profile-CfHDNGqR.jpg";
const projectImg1 = "/Portfolio/assets/project1-Bv_B-1mr.avif";
const projectImg2 = "/Portfolio/assets/project2-C1WS3KYW.avif";
const projectImg3 = "/Portfolio/assets/project3-BQ4w3GzQ.avif";
const projectImg4 = "/Portfolio/assets/project4-BYia65Fs.avif";
const projectImg5 = "/Portfolio/assets/project5-Dr0hjqc5.avif";
const projectImg6 = "/Portfolio/assets/project6-BmPr9xWU.avif";
const assets = {
  computer,
  profileImg
};
...
const projects = [
  {
    title: "To-Do List",
    description: "A responsive To-Do List web app with CRUD operations and task persistence.",
    image: projectImg1,
    tech: ["HTML", "CSS", "JavaScript"]
  },
  {
    title: "SUDOKU",
    description: "A console-based Sudoku game in C++ featuring multiple levels and difficulty settings.",
    image: projectImg2,
    tech: ["C++", "OOP", "Polymorphism", "Inheritance"]
  },
  {
    title: "Google Drive Management System",
    description: "A complete console-based Drive Management System with authentication and file/folder operations.",
    image: projectImg3,
    tech: ["C++", "Trees", "Graphs", "Linked Lists", "Queue"]
  },
  {
    title: "Ping Pong",
    description: "A two-player Ping Pong Game implemented entirely in Assembly language.",
    image: projectImg4,
    tech: ["Assembly Language"]
  },
  {
    title: "Food Ordering App",
    description: "An interactive food ordering prototype built using Figma for restaurant browsing and delivery tracking.",
    image: projectImg5,
    tech: ["Figma", "UI/UX"]
  },
  {
    title: "Word Search",
    description: "A C++-based Word Search game with file handling and dynamic array management.",
    image: projectImg6,
...
const Hero = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 flex flex-col md:flex-row items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:w-1/2 mb-10 md:mb-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-6xl font-bold mb-4", children: [
            "Hi, I'm ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple", children: "Faryal Jafferi" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-4xl font-semibold mb-6 typewriter", children: "Web Developer x Coder" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-300 mb-8", children: "Computer Science student | Developer | Creator | Problem Solver — building modern web solutions with React, Python, and AWS, powered by curiosity and experience from Deloitte." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:w-1/2 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-64 h-64 md:w-80 md:h-80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-gradient-to-r from-purple to-pink animate-pulse opacity-70" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl font-bold text-center mb-4", children: [
          "About",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple", children: " Me" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-center max-w-2xl mx-auto mb-16", children: "Get to know more about my background and passion" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-start md:items-center justify-between gap-8 md:gap-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.img,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold mb-6 text-purple", children: "My Journey" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 mb-8 leading-relaxed", children: "I’m a BS Computer Science student at the FAST National University of Computer and Emerging Sciences I'm passionate about building modern, responsive web applications that combine beautiful design with seamless user experience. My tech journey began with a deep curiosity about how computers work, starting from Assembly and C/C++ to building logic-driven solutions in Python. Over time, I expanded into web development using React, HTML, and CSS, and explored databases like SQL and MongoDB to create dynamic, data-driven applications." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 leading-relaxed", children: "I’ve also gained hands-on experience through AWS architecture simulations and professional exposure with Deloitte, where I learned to combine innovation with real-world problem solving. Passionate about crafting efficient systems and modern web experiences, I aim to keep evolving as a developer who bridges creativity with technology." })
              ]
            }
          )
        ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl font-bold text-center mb-4", children: [
          "My ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple", children: "Skills" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-center max-w-2xl mx-auto mb-16", children: "Technologies & Tools I use to transform ideas into reality" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto", children: skillCategories.map((category, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(category.icon, { className: `text-4xl mb-3 ${category.color}` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-white mb-2", children: category.title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-2", children: category.items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl font-bold text-center mb-4", children: [
          "My ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple", children: "Projects" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-center max-w-2xl mx-auto mb-16", children: "A selection of my recent work" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10", children: projects.map((project, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold mb-2 text-white", children: project.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mb-4", children: project.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mb-4", children: project.tech.map((tech, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "bg-dark-200 p-8 rounded-2xl shadow-lg space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-300 mb-2 text-sm", children: "Your Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-300 mb-2 text-sm", children: "Email Address" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "email",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-300 mb-2 text-sm", children: "Your Message" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
                  rows: "5",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 text-gray-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FaEnvelope, { className: "text-purple text-xl mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-white", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "faryalhyder25@gmail.com" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FaPhoneAlt, { className: "text-purple text-xl mt-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-white", children: "Phone" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "+92 370 1440180" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-white mb-3", children: "Follow Me" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaGithub, { className: "text-2xl" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    rel: "noreferrer",
                    className: "text-gray-400 hover:text-purple transition",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaLinkedin, { className: "text-2xl" })
                  }
                )
              ] })
            ] })
...
const Navbar = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "fixed w-full z-50 bg-dark-100/90 backdrop-blur-sm py-4 px-8 shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "text-3xl font-bold text-white flex items-center space-x-1", children: [
        "Faryal",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple", children: "Jafferi" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 bg-purple rounded-full ml-2" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex space-x-10", children: ["Home", "About", "Skills", "Projects", "Contact"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-0 -bottom-1 w-0 h-0.5 bg-purple transition-all duration-300 group-hover:w-full" })
          ]
        },
        item
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden", children: showMenu ? /* @__PURE__ */ jsxRuntimeExports.jsx(FaXmark, { onClick: () => setShowMenu(false), className: "text-2xl cursor-pointer text-white" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FaBars, { onClick: () => setShowMenu(true), className: "text-2xl cursor-pointer text-white" }) })
    ] }),
    showMenu && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden mt-4 bg-dark-300 h-screen rounded-lg p-4 flex flex-col space-y-6 text-center justify-center", children: ["Home", "About", "Skills", "Projects", "Contact"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
...
const Footer = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-dark-200 text-gray-400 text-center py-6 border-t border-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
    "© ",
    (/* @__PURE__ */ new Date()).getFullYear(),
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-400 font-semibold", children: "Faryal Jafferi" }),
    ". All rights reserved."
  ] }) });
};
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-dark-100 text-white min-h-screen flex flex-col", children: [
